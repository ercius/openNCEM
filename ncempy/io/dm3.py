"""
A module to read DM3 files into python
...
class DM3:
    def __init__(self, filename, verbose = False):
        ...
        #Add a top level varibale to indicate verbosee output for debugging
        self.v = verbose
        ...
        self.curTagName = '' #string of the current tag
         ...
         #text file to write out tags if requested
